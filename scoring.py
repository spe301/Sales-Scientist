...
class Prediction:
	...
	def test(self, X):
		path = r'https://raw.githubusercontent.com/spe301/Sales-Scientist/main/clf.pkl'
	...
	def Probability(self, X):
		...
		try:
			...
			path = r'https://raw.githubusercontent.com/spe301/Sales-Scientist/main/datasets/check6.csv'
	...
	def Opportunity(self, X):
		training_data = pd.read_csv(r'https://raw.githubusercontent.com/spe301/Sales-Scientist/main/datasets/leadsML.csv').drop(['Unnamed: 0'], axis='columns')
...
def WrapScoring(X, data_path, leads_path):
	...
	original_path = r'https://raw.githubusercontent.com/spe301/Sales-Scientist/main/datasets/check6.csv'
